...
namespace SpringStyleItem
{
	public class MyDockedBarControlViewInfo : SkinDockedBarControlViewInfo
	{
		...
		protected override ArrayList PreCalcMultiLineSize(GraphicsCache cache, object sourceObject, int AMaxBarWidth, ref int ARestWidth)
		{
            ArrayList rows = base.PreCalcMultiLineSize(cache, sourceObject, AMaxBarWidth, ref ARestWidth);
